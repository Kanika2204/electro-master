...
<html lang="en">
	<head>
		...
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>		<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
				...
				<div class="container">
					...
					<ul class="header-links pull-right">
						...
						<?php 
							...
							<li><a href="userloginform.php"><i class="fa fa-user-o"></i>Login</a></li>
						<?php 
						}
						?>
					</ul>
